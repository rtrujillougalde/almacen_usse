...
--
-- Table structure for table `stock_puntas`
--

DROP TABLE IF EXISTS `stock_puntas`;
...
--
-- Dumping data for table `stock_puntas`
--

LOCK TABLES `stock_puntas` WRITE;
/*!40000 ALTER TABLE `stock_puntas` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_puntas` ENABLE KEYS */;
UNLOCK TABLES;
